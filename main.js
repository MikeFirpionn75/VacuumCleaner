            ...
            switch (_a.label) {
                case 0:
                    for (i = 0; i < args.length; i++) {
                        ...
                        (0, moveByOrientation_1.move)(vacuumPosition.vacuumOrientation, args[i], vacuumPosition, outOfTheRoom, widthHeight, grid);
                    }
                    if (!outOfTheRoom[0]) return [3 /*break*/, 1];
                    ...
                    return [3 /*break*/, 5];
                case 1:
                    if (!!outOfTheRoom[0]) return [3 /*break*/, 5];
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, check_1.checkTheSizeOfTheRoom)(valid, grid)];
            case 1:
                widthHeight = _a.sent();
                return [4 /*yield*/, (0, check_1.checkThePositionOfTheVacuumCleaner)(valid, widthHeight, vacuumPosition, grid)];
            case 2:
                _a.sent();
                (0, check_1.checkTheInstructions)(valid);
                return [2 /*return*/];
        }
    });
}); })();
