...
function checkTheSizeOfTheRoom(valid, grid) {
...
function checkThePositionOfTheVacuumCleaner(valid, widthHeight, vacuumPosition, grid) {
    return __awaiter(this, void 0, void 0, function () {
